      ...
      <div className="w-[95%] max-w-[1200px] grid md:grid-cols-2 gap-8 text-white">
        <div>
          <h2 className="text-3xl font-bold text-teal-500">
            What does Queuely do?
          </h2>
          <p className="mt-4 text-gray-300">
            Queuely helps businesses manage queues efficiently, reducing wait
            times and improving customer experience with smart scheduling and
            real-time updates.
          </p>
          <button className="bg-teal-400 text-white px-6 py-2 rounded-full mt-6 hover:bg-teal-300">
            <a
              href="mailto:void5265@gmail.com?subject=Let's%20be%20in%20touch!&body=Hello,"
              className="bg-teal-400 text-white px-6 py-2 rounded-full mt-6 hover:bg-teal-300"
            >
              Let’s be in touch!
            </a>
          </button>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="bg-gray-100 p-4 rounded-lg shadow-md">
            ...
            <p className="text-sm text-black ">
              Skip the hassle of visiting in person—schedule your appointment
              online in seconds.
            </p>
          </div>
          <div className="bg-gray-100 p-4 rounded-lg shadow-md">
          ...
          <div className="bg-gray-100 p-4 rounded-lg shadow-md">
            ...
            <p className="text-sm text-black ">
              No more waiting in packed clinics—book online and arrive just in
              time.
            </p>
          </div>
          <div className="bg-gray-100 p-4 rounded-lg shadow-md">
